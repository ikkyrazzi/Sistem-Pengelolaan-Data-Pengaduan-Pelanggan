                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('admin.technician.create') }}" class="btn btn-primary btn-round ms-auto">
                                <i class="fa fa-plus"></i> Create New Technician
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="confirmDelete('{{ route('admin.technician.destroy', $technician->id) }}')">
