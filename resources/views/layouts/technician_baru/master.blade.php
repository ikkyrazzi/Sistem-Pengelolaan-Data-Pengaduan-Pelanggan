...
<head>
    <title>Dashboard | Technician IndonesiaNet</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
    ...
    @include('layouts.technician_baru.partials.sidebar')

    <!-- [ Sidebar Menu ] end --> <!-- [ Header Topbar ] start -->
    @include('layouts.technician_baru.partials.header')
    <!-- [ Header ] end -->
    ...
    @include('layouts.technician_baru.partials.footer')
